...
int Application::m_window_width = 1280, Application::m_window_height = 720;
...
void Application::Init()
{
	...
	m_window = glfwCreateWindow(m_window_width, m_window_height, "BEET SABRE", NULL, NULL);	
...
{
	//Main Loop
	SceneBase *scene = new SceneAcomg();
	//SceneBase *scene = new SceneShadow();
	scene->Init();
