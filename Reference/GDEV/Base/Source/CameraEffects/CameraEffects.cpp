...
// Set the BloodScreen status
void CCameraEffects::SetBloodScreenStatus(const bool m_bStatusBloodScreen)
{
	this->m_bStatusBloodScreen = m_bStatusBloodScreen;
}
// Get the BloodScreen status
bool CCameraEffects::GetBloodScreenStatus(void) const
{
	return m_bStatusBloodScreen;
}
