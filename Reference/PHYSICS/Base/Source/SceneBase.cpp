...
void SceneBase::RenderMeshGO(GameObject* go, MgrGraphics::SHADER shader, bool outline)
{
	MGR_GRAPHICS.RenderMesh(go->GetComponent<CompMesh>(), shader, outline);
}

void SceneBase::RenderText(std::string text, Color color)
{
	MGR_GRAPHICS.RenderText(TEXT, text, color);
}
